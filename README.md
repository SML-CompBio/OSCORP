...
(1) ACSEND_SOFTWARE.ipynb : This notebook contains the code for using this software. The input data is in Data/Software_Data.  
...
![Flow Chart for ACSCEND](https://github.com/SML-CompBio/ACSCEND/blob/main/FlowChart_ACSCEND.png?raw=true)
